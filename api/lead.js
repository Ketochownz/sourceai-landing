...
export default async function handler(request) {
  ...
  const payload = {
    ...
    speed_status: pickStatus(body.speed_status),
    seo_status: pickStatus(body.seo_status),
    reviews_status: pickStatus(body.reviews_status),
    social_status: pickStatus(body.social_status),
    missedcall_answer: typeof body.missedcall_answer === "string" ? body.missedcall_answer.slice(0, 100) : "",
    crm_answer: typeof body.crm_answer === "string" ? body.crm_answer.slice(0, 100) : "",
    voicecoverage_answer: typeof body.voicecoverage_answer === "string" ? body.voicecoverage_answer.slice(0, 100) : "",
